    ...
    en: {
      ...
      prj: [
        { name: 'Interactive Virtual Mockup (IVM)', sub: 'Experience Design · Immersive VR / AR', date: '2024 — 2025', li: [
          ...
          { b: 'Build', t: 'Pipeline from Rhino/Revit into Unity and Meta Quest, shipped over three releases: an interactive base with screenshot and voice annotation, button-driven equipment controls under higher-fidelity lighting, then synchronized multiplayer review of multi-layer ceilings; an AR track places full-scale options on the real site.' },
