...
(() => {
  ...
  const D = {
    ...
    zh: {
      ...
      sums_h: '个人优势',
      sums: [
        { b: '工作背景', t: '约 200 人规模的全球 AEC 设计公司里唯一的设计技术专家。与建筑科学、空间策略、设计可视化三大业务线的 Principal 负责人深度协作，沉到各专业团队里近距离观察真实工作流。一手闭环：用户研究、交互设计、反复测试、设计规范、上线发布、数据追踪到内部推广。相当于在公司内部独立运营一支产品团队，把工作流瓶颈与痛点转化为优雅的技术方案：构建提升设计清晰度、性能与协作的工具、脚本与系统。' },
        { b: '体验设计', t: '完整把控技术型 AEC / BIM 工具的体验设计链路。以用户访谈、工作流分析及定性定量研究为起点，把调研洞察转化为明确的产品改进方向；在多个备选方案中权衡取舍，做低保真到高保真原型，并联合设计师、Senior Associate 与 PM 等一线使用者反复验证。最终上线由可用性测试与行为数据说话，选定方案一路跟到软件落地，实现阶段影响设计的问题一并解决。' },
